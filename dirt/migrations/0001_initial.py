# Generated by Django 2.0.2 on 2018-09-02 00:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origin', models.CharField(choices=[('t-r', 'Transportation'), ('m', 'Meals'), ('s', 'Software'), ('n', 'Network'), ('t', 'Telephone'), ('p', 'Personal equipment'), ('e', 'Equipment'), ('i', 'IT equipment'), ('o', 'Operations'), ('d', 'Donation'), ('s-g', 'Services group activity'), ('s-c', 'Services beach clean'), ('s-s', 'Services IT'), ('l', 'labor'), ('c', 'consultation-meeting')], db_column='source', max_length=30)),
                ...
                ('client', models.CharField(blank=True, db_column='client', max_length=40)),
                ('comments', models.CharField(blank=True, db_column='comments', max_length=100)),
                ('owner', models.ForeignKey(db_column='owner', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'finance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(db_column='owner', on_delete=django.db.models.deletion.DO_NOTHING, related_name='owner', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'projects',
                'ordering': ['project'],
        ...
        migrations.AddField(
            model_name='all_data',
            name='owner',
            field=models.ForeignKey(db_column='owner', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='all_data',
            name='project',
